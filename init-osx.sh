...
# .osx — forked from http://mths.be/osx

dotfiles_home=~/Dropbox/dotfiles
system_name=tyrone
...
# Doesn't work in Mavericks (see http://macosxautomation.com/mavericks/guiscripting/index.html)
...
# modified from
# https://raw.github.com/altercation/solarized/master/osx-terminal.app-colors-solarized/Solarized%20Light%20ansi.terminal
# https://raw.github.com/altercation/solarized/master/osx-terminal.app-colors-solarized/Solarized%20Dark%20ansi.terminal
...
for app in "Address Book" "Calendar" "Contacts" "Dock" "Finder" "Mail" \
	"Messages" "Safari" "SizeUp" "SystemUIServer" "Terminal" "iCal" \
	"iTunes"; do
